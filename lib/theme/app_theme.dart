...
class AppTheme {
  static final lightTheme = LightTheme.data;
  static final darkTheme = DarkTheme.data;
}
...
class LightModeColors {
  static const lightPrimary = Color(0xFFFF0000);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFF5F5F5);
  static const lightOnPrimaryContainer = Color(0xFF1A1A1A);
  static const lightSecondary = Color(0xFF7C4DFF);
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFF00BFA5);
